...
- ⚠️ **权限确认弹窗**：ZCode 需要确认权限（执行命令/写文件等）时，桌宠在气泡下方弹出确认窗，显示工具名/风险/参数摘要，一键跳转 ZCode 确认
...
1. 从 [Releases](https://github.com/YZX-Der/zcode-pet/releases) 下载 `zcode-pet_0.2.4_aarch64.dmg`
...
- **显示桌宠** / **始终置顶**：全局开关
- **状态气泡** / **气泡消失时间**：气泡开关 + 自动消失时长（2/3/5/10 秒）
- **宠物大小** / **不透明度**：滑块实时预览
